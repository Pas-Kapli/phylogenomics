...
if __name__ == "__main__":
    ...
    plot_data(axes[2], data1, data2, "phi", r"$\varphi$", sys.argv[1], sys.argv[2])
    fig.suptitle(r'Posterior means and 95% CI for parameters $\tau$, $\theta$ and $\varphi$')

    # Hide the unused subplot
    #axes[1, 1].axis('off')

    plt.tight_layout()
    plt.savefig("posterior.png", format='png', dpi=300)
    plt.close("all")
